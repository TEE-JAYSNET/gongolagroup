...
import heroHollowBlocks from "@/assets/hero-hollow-blocks.jpg";
      ...
      <div className="relative h-full flex flex-col justify-center items-center text-center px-4 z-20">
        <div className="max-w-3xl animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild size="lg" className="min-w-[200px] rounded-full bg-primary hover:bg-primary/90">
              <Link to="/quote">{t.hero.getQuote}</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="min-w-[200px] rounded-full border-white text-white hover:bg-white hover:text-primary">
