    ...
    <footer className="bg-card text-card-foreground pt-16 pb-8 border-t">
      <div className="container">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">
                  Cop 14 Dubai-Abuja Int'l Trade
                  <br />
                  Center, Behind Games
                  <br />
                  Village, FCT-Abuja
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">+234 803 317 7057</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-2 text-primary" />
                <span className="text-muted-foreground">
                  info@gongolagroup.com
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8 mt-8 text-center text-muted-foreground">
          <p>
            &copy; {currentYear} Gongola Group | TEE-JAYS NET.{" "}
            {t.footer.allRights}
          </p>
        </div>
      </div>
